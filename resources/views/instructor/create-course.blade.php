		...
		<div class="wrapper">
			...
			<section class="vid-title-sec">
				<h1 class="heading-name-page"><strong style="color: #757575; font-weight: 700;">مرحبا بك أيها الرائع |</strong>
					قم في إنشاء كورسك الان</h1>
				<form  id="formData" method="post" action="{{route('save-course')}}" enctype="multipart/form-data" class="row pl-5 pr-5">
					@csrf
...
{{--							<input type="file"  name="image" id="image" required hidden />--}}
							...
							<div class="container" style="padding-left: 0 !important; padding-right: 0 !important;">
								...
								<div class="vid-title">
									...
									<div class="form_field">
										<input type="text" name="name" required placeholder="50 حرف كا أقصى حد">
									</div>
								</div>
								...
								<div class="abt-vidz-pr" style="margin-bottom: -20px;">
									...
									<div class="form_field">
										<textarea name="description" required placeholder="وصف الكورس"></textarea>
									</div>
								</div>
									...
									<div class="row" style="align-items: baseline;">
										<div class="col-lg-3 col-md-5 col-sm-5 col-12">
											...
											<div class="form_field pr">
												<input name="price" type="text" required placeholder="1,000">
											</div>
										</div>
										<div class="col-lg-4 col-md-7 col-sm-7 col-12">
											<div class="option">
												...
												<div class="form_field">
													<select id="categories" required name="category">
														<option>برمجة</option>
										...
										<div class="col-lg-5 col-md-12 col-sm-12 col-12">
											<div class="option">
												<h2 class="title-hd" style="font-size: 13px; font-weight: bold; margin-top: 15px;"> إضافة الكورس إلى أحد
													دبلوماتك <span style="color: red; font-size: 13px; font-weight: bold;"> إختياري * </span>
												</h2>
												<div class="form_field">
													<select id="diplomas" name="diploma">
														<option value="-1">بدون دبلوم</option>
								...
								<div class="abt-tags">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-12">
											<h2 class="title-hd">كلمات مفتاحية</h2>
											<div class="form_field pr">
												<input type="text" name="keyword" required placeholder=" #يرمجة ويب #برمجة شبكات">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="btn-sbmit">
									<!-- Start Button Create Courses -->
										...
										<button type="submit" style="width: 40%;">إنشاء الكورس</button>
        ...
        <script type="module" src="{{asset('assets/js/instructor/createCourse.js?x='.time())}}"></script>
