...
<html lang="ar">
  ...
  <head>
    ...
    <title>كورس | تفاصيل الدبلوم</title>
    <!-- Start Icons Website -->
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/uploads-video.css">
    <link rel="stylesheet" type="text/css" href="assets/css/style-video-player.css">
  ...
  <body>
          ...
          <div class="container">
            <div class="top_header_content">
              ...
              <ul class="controls-lv">
                ...
                <li>
                  <a href="Upload_Video.html" title="" class="btn-default">
                    تسجيل الدخول
                  </a>
                </li>
              </ul>
      ...
      <section class="mn-sec full_wdth_single_video">
        <div class="row" style="background-color: #191919 !important; color: #FFF; height: 80vh;">
          <div class="row">
            ...
            border-radius: 10px;
            ">
              <img src="assets/images/web3-00.jpg" alt="" width="100%" style="height: 50%; object-fit: fill;">
              <ul style="
              ...
              <div style="display: flex; justify-content: center; margin-top: 30px;">
                <button class="btn btn-primary" type="button" style="width: 70%;">شراء الدبلوم</button>
              </div>
            </div>
            <div class="col-lg-6" style="padding: 25px;">
              <div style="margin-right: 70px;">
                <h1 style="margin-bottom: 15px; margin-top: 70px;">دبلوم برمجة المواقع الإلكترونية من الصفر حتى الإحتراف
                  في لغات تصميم الواجهات HTML & CSS & JS و لغات
                  برمجة الصفحات PHP و قواعد بيانات MYSQL</h1>
                <p style="color: #888;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi quia nemo error
                  quidem dicta dolores,
                  voluptate vel, laborum neque possimus totam! Consequuntur laborum perspiciatis voluptas vel ducimus
                  voluptatum atque? Assumenda.</p>
                <div style="display: flex; justify-content: space-evenly; align-items: center;">
                  <ul style="
                              margin: 20px 30px 5px 0;
                              ">
                    <li><i class="icon-user" style="margin-left: 10px; font-size: 20px;"></i>هشام السقاف</li>
                    <li><i class="icon-light" style="margin-left: 10px; font-size: 20px;"></i>علوم حاسوب
                    </li>
                    <li><i class="icon-settings" style="margin-left: 10px; font-size: 20px;"></i>20%</li>
                  </ul>
                  <ul style="
                              margin: 20px 30px 5px 0;
                              ">
                    <li>
                      <i class="icon-subscriptions" style="margin-left: 10px; font-size: 20px;"></i>877 الطلاب المشتركين
                    </li>
                    <li>
                    ...
                    <li>
                      <i class="icon-menu" style="margin-left: 10px; font-size: 20px;"></i>
                     عدد الكورسات 12
                    </li>
                  </ul>
                </div>
    ...
    <script src="assets/js/script-video-player.js"></script>
    <script src="assets/js/script-uploads-video.js"></script>
